...
//#define REDIS_ADDR ((unsigned long int)0x0A000206) //10.0.2.6			/* 31 May TJChoi : could be replaced by argv[]  */
#define REDIS_ADDR ((unsigned long int)0xc0a8858d) //192.168.133.141
